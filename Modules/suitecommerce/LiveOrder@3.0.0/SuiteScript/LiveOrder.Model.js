/*
	...
	BB1 G Truslove, add quantity on hand and available.
*/
	...
	,	getLines: function (order_fields)
		{
			...
			if (order_fields.items && order_fields.items.length)
			{
				...
				_.each(order_fields.items, function (original_line)
				{
					...
					,	quantityonhand: original_line.quantityonhand
					,	quantityavailable: original_line.quantityavailable
					,custitem_bb1_nextpoduedate:original_line.custitem_bb1_nextpoduedate
					};
					// @class LiveOrder.Model
