	...
	,	getContext: function ()
		{
			...
			var nextpoduedate=item.get('custitem_bb1_nextpoduedate');
			...
			return {
				...
				,backOrderWarning:item.get('quantity')>item.get('quantityavailable')
				,showBackOrderDate:nextpoduedate&&nextpoduedate.length>0
				,custcol_bb1_itemnextpoduedate:	nextpoduedate			
			};
		}
	});
});
