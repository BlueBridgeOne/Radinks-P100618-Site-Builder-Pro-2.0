	...
	,	jQuery)
{
	...
	,	initialize: function (options)
		{
			console.log("Open pay invoices");
			this.wizard = options.wizard;
			this.invoices = new InvoiceCollection();
			var models=this.wizard.model.get('invoices').models;
			if(models){
			console.log("Invoices passed to payment "+models.length);
			}else{
				console.log("No invoices passed to payment.");
			}
	...
	,	getContext: function ()
		{
			console.log("Render pay invoices");
