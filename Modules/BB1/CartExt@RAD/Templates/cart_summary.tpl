	...
	<div class="cart-summary-container">
		...
		{{#if isPriceEnabled}}
			...
			{{#if showActions}}
				...
				{{#if containsBackorders}}
				<div>
					<p><small class="input-required">*</small> Confirm Your Backorders <input id="confirmBackorders" type="checkbox" /></p>
					<br />
				</div>
				{{/if}}
					<a data-action="startCheckout" id="btn-proceed-checkout" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}}" href="#" >
