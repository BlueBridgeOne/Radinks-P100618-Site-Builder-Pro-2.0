	...
	)
{
	...
	//{
	//	console.log('Configured Checkout steps AMD module not found for ' + configuredCheckoutStepsName + '. Using opc flow');
		configuredCheckoutSteps = Utils.requireModules('SC.Checkout.Configuration.Steps.OPC');
	//}
