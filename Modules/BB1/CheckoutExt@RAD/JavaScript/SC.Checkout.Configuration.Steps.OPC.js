...
define(
	...
	function(
		_, Utils, OrderWizardModuleMultiShipToEnableLink, OrderWizardModuleCartSummary, OrderWizardModuleAddressShipping, OrderWizardModulePaymentMethodGiftCertificates, OrderWizardModulePaymentMethodSelector, OrderWizardModulePaymentMethodPurchaseNumber, OrderWizardModulePaymentMethodReference, OrderWizardModuleAddressBilling, OrderWizardModuleRegisterEmail, OrderWizardModuleShowPayments, OrderWizardModuleSubmitButton, OrderWizardModuleTermsAndConditions, OrderWizardModuleConfirmation, OrderWizardModuleRegisterGuest, OrderWizardModulePromocodeForm
		...
		var address_opc_options = {
			...
			split_address_opc_options = {
				container: '#wizard-step-content-splitleft',
				title: _('Enter Shipping Address').translate(),
				hide_title: true,
			},
		...
		return [{
				...
				steps: [{
					...
					modules: [
						[OrderWizardModuleTitle, { container: '#wizard-step-content-splitleft',title: _('Shipping Address').translate(), exclude_on_skip_step: true, isActive: function() { return this.wizard.model.shippingAddressIsRequired(); } }], OrderWizardModuleMultiShipToEnableLink, 
						[OrderWizardModuleAddressShipping, split_address_opc_options],
						[OrderWizardModuleTitle, { container: '#wizard-step-content-splitright',title: _('Billing Address').translate(), enable_same_as: function() { return !this.wizard.model.get('ismultishipto') && this.wizard.model.shippingAddressIsRequired(); } }],
						[OrderWizardModuleAddressBilling, { container: '#wizard-step-content-splitright',enable_same_as: function() { return !this.wizard.model.get('ismultishipto') && this.wizard.model.shippingAddressIsRequired(); } }],
						...
						[OrderWizardModulePaymentMethodSelector, { record_type: 'salesorder', preventDefault: true }], OrderWizardModulePaymentMethodPurchaseNumber, OrderWizardModulePaymentMethodReference
			...
			, {
				...
				steps: [{
					...
					modules: [
						OrderWizardModuleMultiShipToEnableLink, [OrderWizardModuleMultiShipToPackageCreation, { edit_addresses_url: 'shipping/selectAddress' }], OrderWizardModuleMultiShipToPackageList, OrderWizardModuleNonShippableItems, [OrderWizardModuleCartSummary, cart_summary_options],
						[OrderWizardModulePromocodeForm, { container: '#wizard-step-content-right' }]
					]
				}]
			}
			...
			, {
				...
				steps: [{
					...
					modules: [
						OrderWizardModulePaymentMethodGiftCertificates, [OrderWizardModulePaymentMethodSelector, { record_type: 'salesorder', prevent_default: true }], OrderWizardModulePaymentMethodPurchaseNumber, OrderWizardModulePaymentMethodReference, [OrderWizardModuleAddressBilling, {
